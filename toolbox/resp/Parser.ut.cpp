...
BOOST_AUTO_TEST_CASE(SimpleStringCase)
{
    ...
    BOOST_CHECK_EQUAL(parse("+OK\r\n"sv), "+OK");
    BOOST_CHECK_EQUAL(parse("+OK\r"sv), "");
    BOOST_CHECK_EQUAL(parse("+foo bar\r\n"sv), "+foo bar");
    BOOST_CHECK_EQUAL(parse("+foo bar!\r\n+OK\r\n"sv), "!,+OK");
}
...
{
    BOOST_CHECK_EQUAL(parse("-\r\n"sv), "-");
    BOOST_CHECK_EQUAL(parse("-Error message\r\n"sv), "-Error message");
    BOOST_CHECK_EQUAL(parse("-Error message\r"sv), "");
    BOOST_CHECK_EQUAL(parse("-ERR unknown command 'foobar'\r\n"sv),
...
{
    BOOST_CHECK_EQUAL(parse(":\r\n"sv), ":0");
    BOOST_CHECK_EQUAL(parse(":0\r\n"sv), ":0");
    BOOST_CHECK_EQUAL(parse(":0\r"sv), "");
    BOOST_CHECK_EQUAL(parse(":123\r\n"sv), ":123");
    BOOST_CHECK_EQUAL(parse(":+123\r\n"sv), ":123");
    BOOST_CHECK_EQUAL(parse(":-123\r\n"sv), ":-123");
    BOOST_CHECK_EQUAL(parse(":-123!\r\n+OK\r\n"sv), "!,+OK");
...
{
    BOOST_CHECK_EQUAL(parse("$0\r\n\r\n"sv), "+");
    BOOST_CHECK_EQUAL(parse("$6\r\nfoobar\r\n"sv), "+foobar");
    BOOST_CHECK_EQUAL(parse("$7\r\nfoo bar\r\n"sv), "+foo bar");
    BOOST_CHECK_EQUAL(parse("$7\r\nfoo bar!\r\n+OK\r\n"sv), "!,+OK");
    BOOST_CHECK_EQUAL(parse("$7\r\nfoo bar!\r\n+OK\r\n"sv), "!,+OK");
...
BOOST_AUTO_TEST_CASE(ArrayCase)
{
    BOOST_CHECK_EQUAL(parse("*0\r\n"sv), "[]");
    BOOST_CHECK_EQUAL(parse("*0!\r\n+OK\r\n"sv), "~!,+OK");
    BOOST_CHECK_EQUAL(parse("*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n"sv), "[+foo,+bar]");
    BOOST_CHECK_EQUAL(parse("*2\r\n$3\r\nfoo!\r\n$3\r\nbar\r\n+OK\r\n"sv), "[!~,+OK");
    BOOST_CHECK_EQUAL(parse("*3\r\n:1\r\n:2\r\n:3\r\n"sv), "[:1,:2,:3]");
    BOOST_CHECK_EQUAL(parse("*3\r\n:1\r\n:2\r\n:3!\r\n+OK\r\n"sv), "[:1,:2,~!,+OK");
    BOOST_CHECK(parse("*5\r\n:1\r\n:2\r\n:3\r\n:4\r\n$6\r\nfoobar\r\n"sv)
                == "[:1,:2,:3,:4,+foobar]");
    BOOST_CHECK(parse("*5\r\n:1\r\n:2\r\n:3!\r\n:4\r\n$6\r\nfoobar\r\n+OK\r\n"sv)
