...
{
    BOOST_CHECK_EQUAL(5_test, 5_test);
}

BOOST_AUTO_TEST_CASE(IntNotEqualToCase)
{
    BOOST_CHECK_NE(5_test, 7_test);
}

BOOST_AUTO_TEST_CASE(IntLessThanCase)
{
    BOOST_CHECK_LT(5_test, 7_test);
}

BOOST_AUTO_TEST_CASE(IntGreaterThanCase)
{
    BOOST_CHECK_GT(5_test, 3_test);
}

BOOST_AUTO_TEST_CASE(IntLessThanOrEqualToCase)
{
    BOOST_CHECK_LE(5_test, 5_test);
    BOOST_CHECK_LE(5_test, 7_test);
}

BOOST_AUTO_TEST_CASE(IntGreaterThanOrEqualToCase)
{
    BOOST_CHECK_GE(5_test, 5_test);
    BOOST_CHECK_GE(5_test, 3_test);
}

BOOST_AUTO_TEST_CASE(IntInsertionCase)
{
    BOOST_CHECK_EQUAL(lexical_cast<string>(5_test), "5");
}
